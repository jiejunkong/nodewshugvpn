...
const UUID = process.env.UUID || '85881de4-fc8b-4996-8ad7-344787df76c5'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const DOMAIN = process.env.DOMAIN || 'jiejunkong-wstest.hf.space';       // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
